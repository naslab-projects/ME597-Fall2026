...
Major Operating Systems (OS) Linux, Windows, and MacOS all support ROS2, however, certain features are broken in Windows and MacOS. Hence, it is advised that ROS 2 run on a Linux machine.
